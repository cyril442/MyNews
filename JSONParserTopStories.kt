...
class JSONParserTopStories(private var c: Context, private var jsonData: String, private var recyclerView: RecyclerView) :
...
//        }
    ...
    class MrAdapter(private var c: Context, private var topStoriesSciences: ArrayList<TopStoriesScience>) :
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MrAdapter.MyViewHolder {
            // create a new view
        ...
        override fun getItemCount(): Int {
         ...
         fun onBindViewHolder(holder: MrAdapter.MyViewHolder, position: Int, view: RecyclerView, viewGroup: ViewGroup?, i :Int) {
...
//                    val url_multimedia = jom.getString("url")
                    ...
                    topStoriesScience =
                        TopStoriesScience(title, section, subsection, updated_date)
